...
var fileDescriptor_08b73fb6bfa52be9 = []byte{
	...
	0x30, 0x41, 0xd4, 0x80, 0xd8, 0x46, 0xf5, 0x10, 0x63, 0x82, 0x53, 0x8b, 0xca, 0x32, 0x93, 0x53,
	0x85, 0x8c, 0xb9, 0x38, 0x82, 0x13, 0x2b, 0x3d, 0x52, 0x73, 0x72, 0xf2, 0x85, 0x04, 0xf5, 0xc0,
	0x96, 0x22, 0xd9, 0x22, 0x25, 0x84, 0x2c, 0x04, 0x31, 0x55, 0x89, 0x41, 0xc8, 0x9a, 0x4b, 0x00,
	0xa6, 0xc9, 0xa9, 0x32, 0xb4, 0x38, 0xb5, 0xc8, 0x33, 0x85, 0x68, 0xcd, 0x4e, 0x3c, 0x51, 0x5c,
	0x08, 0x6f, 0x26, 0xb1, 0x81, 0xd9, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0x86, 0x12, 0x56,
...
type DemoServiceClient interface {
	...
	SayHelloByUserId(ctx context.Context, in *DemoRequest, opts ...client.CallOption) (*DemoResponse, error)
}
...
func (c *demoServiceClient) SayHelloByUserId(ctx context.Context, in *DemoRequest, opts ...client.CallOption) (*DemoResponse, error) {
...
type DemoServiceHandler interface {
	...
	SayHelloByUserId(context.Context, *DemoRequest, *DemoResponse) error
}
...
func (h *DemoService) SayHelloByUserId(ctx context.Context, in *DemoRequest, out *DemoResponse) error {
